const fetch = require("node-fetch"); // Consider migrating to native fetch if Node version allows
const fs = require("fs").promises; // Use promise-based fs
const axios = require("axios");
const cfonts = require("cfonts");
const Crypto = require("crypto");
const chalk = require("chalk");
const { exec } = require("child_process"); // Keep exec for tesseract
...
// const request = require('request'); // Removed obsolete request
...
const banner3 = cfonts.render(('TED|BOT|V3.6'), {
  font: 'block',
  align: "center",
  colors: ['blue', 'red'], // Usando azul e vermelho
});
...
const authorname = "TED-BOT"
const packname = "Criador: @jeova_alves7"
